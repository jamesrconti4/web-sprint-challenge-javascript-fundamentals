...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nestedFunction can access internal because the variable is within the scope of the outer function along with nestedFunction, so the nested function can reach out to access the variable
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const bigNum = array.reduce(function(acc, item){
